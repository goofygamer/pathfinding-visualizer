...
def dijkstras(grid, tickTime):
    ...
    while True:
        ...
        for neighbor in current.neighbors:
            ...
            if neighbor != start and neighbor != end and not visited[neighbor]:
...
algMenu = ttk.Combobox(UI_frame, textvariable=selected_alg, 
                       values=['A* Algorithm', 'Breadth-First Algorithm', "Dijkstra's Algorithm"], font = font)
